...
nvcc -arch=sm_37 --ptxas-options=-v -use_fast_math gpu_main_c4.cu -o gpu_main_c3 -I./..
nvcc -arch=sm_37 --ptxas-options=-v -use_fast_math gpu_main_c5.cu -o gpu_main_c3 -I./..
